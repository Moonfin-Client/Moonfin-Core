...
List<_SettingsSearchEntry> _buildSettingsSearchIndex({
  ...
  final entries = <_SettingsSearchEntry>[
    ...
    parental.screen(
      keywords: ['parental controls', 'age', 'content rating', 'block', 'kids'],
    ),
    ...
    details.leaf(
      ...
      l10n.detailScreenStyle,
      keywords: ['classic', 'modern', 'spotlight'],
    ),
    ...
    video.leaf(
      'player_zoom_mode',
      l10n.playerZoomMode,
      keywords: ['aspect ratio', 'crop', 'stretch'],
    ),
    ...
    video.leaf(
      'skipForwardLength',
      l10n.skipForwardLength,
      keywords: ['seek forward'],
    ),
    if (PlatformDetection.useMobileUi) ...[
      video.leaf(
        'osdLockEnabled',
