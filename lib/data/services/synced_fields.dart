...
final List<SyncedField> syncedFields = <SyncedField>[
  ...
  SyncedField('favoritesRowSortOrder', UserPreferences.favoritesRowSortOrder, SyncCodec.enumName, enumValues: prefs.SortOrder.values),
  ...
  SyncedField('collectionsRowSortOrder', UserPreferences.collectionsRowSortOrder, SyncCodec.enumName, enumValues: prefs.SortOrder.values),
  SyncedField('genresRowSortBy', UserPreferences.genresRowSortBy, SyncCodec.enumName, enumValues: prefs.LibrarySortBy.values),
  SyncedField('genresRowSortOrder', UserPreferences.genresRowSortOrder, SyncCodec.enumName, enumValues: prefs.SortOrder.values),
  ...
  SyncedField('audioRowsSortOrder', UserPreferences.audioRowsSortOrder, SyncCodec.enumName, enumValues: prefs.SortOrder.values),
  ...
  SyncedField('playlistsRowSortOrder', UserPreferences.playlistsRowSortOrder, SyncCodec.enumName, enumValues: prefs.SortOrder.values),
